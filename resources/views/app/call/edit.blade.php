        ...
        <form method="POST" action="{{ route('app.call.update', $call->id) }}">
                    ...
                    <label>
                        ...
                        <select name="lead_id">
                            ...
                            @foreach($leads as $lead)
                                @if($lead->id == old('lead_id', $call->lead_id))
                    ...
                    <label>
                        ...
                        <select name="contact_id">
                            ...
                            @foreach($contacts as $contact)
                                @if($contact->id == old('contact_id', $call->contact_id))
                    ...
                    <label>
                        ...
                        <select name="account_id">
                            ...
                            @foreach($accounts as $account)
                                @if($account->id == old('account_id', $call->account_id))
            ...
            <div class="row">
                <fieldset class="col-xs-12">
                    <label>
                        Content*
                        <textarea name="content">{{ old('content', $call->content) }}</textarea>
